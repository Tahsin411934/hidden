...
class PrintController extends Controller
{
    public function admitCard($id)
    {
        ...
        $exam_controller_signature = $signature ? $signature->signature_image_path : null;
        $institute_head_signature = $branchsignature ? $branchsignature->signature_image_path : null;
