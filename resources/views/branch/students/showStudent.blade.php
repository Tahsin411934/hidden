            ...
            <div class="bg-gray-50 p-5 rounded-xl border border-gray-200 shadow-sm">
                <div class="flex flex-col items-center">
                    <div class="relative mb-4">
                        @if ($students->image)
                            <img id="imagePreview" src="{{ asset('/storage/app/public/' . $students->image) }}" 
            ...
            <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" value="{{ $students->name ?? 'NA' }}" 
                               class="w-full p-2 rounded-md border border-gray-300 bg-gray-50" readonly disabled>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Father's Name</label>
                        <input type="text" value="{{ $students->father_name ?? 'NA' }}" 
                               class="w-full p-2 rounded-md border border-gray-300 bg-gray-50" readonly disabled>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Mother's Name</label>
                        <input type="text" value="{{ $students->mother_name ?? 'NA' }}" 
                               class="w-full p-2 rounded-md border border-gray-300 bg-gray-50" readonly disabled>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
                        <input type="text" value="{{ $students->phone_number ?? 'NA' }}" 
                               class="w-full p-2 rounded-md border border-gray-300 bg-gray-50" readonly disabled>
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Address</label>
                        <input type="text" value="{{ $students->address ?? 'NA' }}" 
                               class="w-full p-2 rounded-md border border-gray-300 bg-gray-50" readonly disabled>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" value="{{ $students->tana ?? 'NA' }}" 
                               class="w-full p-2 rounded-md border border-gray-300 bg-gray-50" readonly disabled>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Village</label>
                        <input type="text" value="{{ $students->vill ?? 'NA' }}" 
                               class="w-full p-2 rounded-md border border-gray-300 bg-gray-50" readonly disabled>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                            @if ($students->signature)
                                <img src="{{ asset('/storage/app/public/' . $students->signature) }}" class="w-full h-32 object-contain mx-auto">
                            @else
