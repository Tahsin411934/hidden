<x-app-layout>
    ...
    function showBranchDetails(branch) {
        document.getElementById('modalBranchName').textContent = branch.branch_name || 'N/A';
