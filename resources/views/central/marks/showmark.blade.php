        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6 p-6 border border-gray-100">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-2xl font-semibold text-[#f04933]">Update Marks for {{ $student->name }}</h2>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border border-gray-100">
                <form method="POST" action="{{ route('marks.update', $mark->id) }}" id="marksForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="overflow-x-auto border border-gray-200 rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-[#f0632b] text-white">
                                <tr>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <input type="number" name="academic_assessment" id="academic" class="mark-input w-full px-2 py-1 border border-gray-300 rounded focus:ring-1 focus:ring-[#006172] focus:border-[#006172]" min="0" max="300" step="0.01" value="{{ $mark->academic_assessment }}" required>
                                    </td>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <input type="number" name="written" id="written" class="mark-input w-full px-2 py-1 border border-gray-300 rounded focus:ring-1 focus:ring-[#006172] focus:border-[#006172]" min="0" max="50" step="0.01" value="{{ $mark->written }}" required>
                                    </td>
                                    <td class="px-4 py-3 whitespace-nowrap text-gray-700">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <input type="number" name="practical" id="practical" class="mark-input w-full px-2 py-1 border border-gray-300 rounded focus:ring-1 focus:ring-[#006172] focus:border-[#006172]" min="0" max="40" step="0.01" value="{{ $mark->practical }}" required>
                                    </td>
                                    <td class="px-4 py-3 whitespace-nowrap text-gray-700">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <input type="number" name="viva" id="viva" class="mark-input w-full px-2 py-1 border border-gray-300 rounded focus:ring-1 focus:ring-[#006172] focus:border-[#006172]" min="0" max="10" step="0.01" value="{{ $mark->viva }}" required>
                                    </td>
                                    <td class="px-4 py-3 whitespace-nowrap text-gray-700">
                                ...
                                <tr class="bg-gray-100 font-semibold">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap text-gray-700">100</td>
                                    <td class="px-4 py-3 whitespace-nowrap">
                                ...
                                <tr class="bg-[#f0f9fa]">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap" colspan="2">
                                        <div class="w-full px-2 py-1 bg-white border border-[#006172] rounded text-center font-bold text-[#006172]" id="grade_display">{{ $mark->grade ?? '-' }}</div>
                                        <input type="hidden" id="grade" name="grade" value="{{ $mark->grade ?? '' }}">
                                    </td>
                                </tr>
                                <tr class="bg-[#f0f9fa]">
                                    <td class="px-4 py-3 whitespace-nowrap font-bold text-[#006172]" colspan="2">GPA</td>
                                    <td class="px-4 py-3 whitespace-nowrap" colspan="2">
                                        <div class="w-full px-2 py-1 bg-white border border-[#006172] rounded text-center font-bold text-[#006172]" id="gpa_display">{{ $mark->gpa ?? '-' }}</div>
                                        <input type="hidden" id="gpa" name="gpa" value="{{ $mark->gpa ?? '' }}">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="mt-6 flex justify-end">
                        <button type="submit" class="px-6 py-2 bg-[#e66429] border border-transparent rounded-md font-medium text-white hover:bg-[#004d5a] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#006172] transition">
                            Update Marks
                        </button>
                    </div>
                </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function calculateResults() {
                ...
                // Calculate percentages based on max marks from your controller validation
                ...
                // Total marks out of 100 (30+40+20+10)
