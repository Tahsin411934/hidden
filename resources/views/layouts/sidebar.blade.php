                ...
                <div class="px-2">
                    ...
                    <div id="student-dropdown" class="mb-1">
                        ...
                        <div id="student-dropdown-list" class="mt-1 space-y-1 pl-8 hidden">
                            ...
                            <a href="/central/branch/students"
                                class="flex items-center px-3 py-2 text-sm font-medium text-blue-200 rounded-lg hover:bg-blue-700 hover:text-white group transition">
                                <span class="w-1.5 h-1.5 rounded-full bg-blue-400 mr-3"></span>
                                <span class="whitespace-nowrap transition-all duration-300 sidebar-text">Branch Students</span>
                            </a>
                    ...
                    <div id="courses-dropdown" class="mb-1">
                        ...
                        <div id="courses-dropdown-list" class="mt-1 space-y-1 pl-8 hidden">
                            <a href="/categories" class="flex items-center px-3 py-2 text-sm font-medium text-blue-200 rounded-lg hover:bg-blue-700 hover:text-white group transition">
                                <span class="w-1.5 h-1.5 rounded-full bg-blue-400 mr-3"></span>
                                <span class="whitespace-nowrap transition-all duration-300 sidebar-text">Category</span>
                            </a>
                            <a href="/courses" class="flex items-center px-3 py-2 text-sm font-medium text-blue-200 rounded-lg hover:bg-blue-700 hover:text-white group transition">
                                <span class="w-1.5 h-1.5 rounded-full bg-blue-400 mr-3"></span>
                    ...
                    <div id="results-dropdown" class="mb-1">
                        ...
                        <div id="results-dropdown-list" class="mt-1 space-y-1 pl-8 hidden">
                            ...
                            <a href="/result" class="flex items-center px-3 py-2 text-sm font-medium text-blue-200 rounded-lg hover:bg-blue-700 hover:text-white group transition">
                                <span class="w-1.5 h-1.5 rounded-full bg-blue-400 mr-3"></span>
