<x-guest-layout>
    <div class="bg-gradient-to-r from-[#003E59] to-[#28708f] px-36 py-4">
        <h2 class="text-3xl font-bold text-[#f7f9fa]">Branch Locator</h2>
        <p class="text-base text-[#f7f9fa] mt-1">Find branches by division and district, Change division and district to
            find a Regional branch.</p>
    </div>
    <div class="min-h-screen max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <!-- Filter Section with Colorful Header -->

        <div class=" rounded-lg shadow-md p-1 mb-6">
        ...
        <div id="branchesContainer">
            ...
            <div id="selectBothMessage"
                class="bg-white rounded-lg shadow-md border border-[#003E59]/20 p-6 text-center">
                <div class="w-16 h-16 mx-auto bg-[#003E59]/10 rounded-full flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-[#003E59]" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p class="mt-2 text-xs text-gray-600">Please select both division and district to view branch details
                </p>
            ...
            <div id="noResultsMessage"
                class="bg-white rounded-lg shadow-md border border-[#F37021]/20 p-6 text-center hidden">
                <div class="w-16 h-16 mx-auto bg-[#F37021]/10 rounded-full flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-[#F37021]" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-2">
                                    <h3
                                        class="text-lg font-bold text-[#003E59] group-hover:text-[#F37021] transition-colors truncate">
                                        {{ $branch->branch_name }}
                                    </h3>
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-bold bg-[#F37021]/10 text-[#F37021] border border-[#F37021]/20">
                                        Branch #{{ $branch->id }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <a href="tel:{{ $branch->phone }}"
                                class="inline-flex items-center justify-center px-3 py-1.5 border border-transparent text-xs font-bold rounded shadow-sm text-white bg-[#F37021] hover:bg-[#E0651C] whitespace-nowrap transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 mr-1.5" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="p-5 pt-4">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                            ...
                            <div class="flex items-start p-3 bg-[#003E59]/5 rounded-lg">
                                <div
                                    class="w-8 h-8 bg-[#003E59]/10 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-[#003E59]" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div>
                                    <p class="font-semibold text-[#003E59] text-xs uppercase tracking-wider mb-1">
                                        Location</p>
                                    <p class="text-gray-800">{{ $branch->division_name }}, {{ $branch->district_name }}
                                    </p>
                            ...
                            <div class="flex items-start p-3 bg-[#F37021]/5 rounded-lg">
                                <div
                                    class="w-8 h-8 bg-[#F37021]/10 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-[#F37021]" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                    </svg>
                                ...
                                <div>
                                    <p class="font-semibold text-[#F37021] text-xs uppercase tracking-wider mb-1">
                                        Contact</p>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function checkFilters() {
            ...
            // If only one filter is selected, show instruction message
                ...
                selectBothMessage.querySelector('p').textContent =
                    'You need to select both filters to view branches';
            }
            // If no filters are selected, show initial instruction
                ...
                selectBothMessage.querySelector('p').textContent =
                    'Please select both division and district to view branch details';
            }
        }
